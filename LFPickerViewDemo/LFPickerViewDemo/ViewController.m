...
@interface ViewController ()<UITableViewDelegate,UITableViewDataSource,LFPickerViewDelegate>
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (indexPath.row == 0) {
        LFPickerView *picker = [[LFPickerView alloc]initWithFrame:self.view.bounds];
